| 15 核辅助工具.(kernel lib) This file contains a number of assembly code utility routines needed by the
| kernel.  They are:
|
...
|*===========================================================================*
|*				phys_copy : 把物理存储中任意一处的数据块复制到别的任何地方.两个地址都是绝对地址.   *
|*===========================================================================*
...
|*===========================================================================*
|*				get_chrome : 使用BIOS调用,找出屏幕是单色还是彩色.			     *
|*===========================================================================*
...
|*===========================================================================*
|*				vid_copy : copy data to video ram.在显示器上显示字符.			*
|*===========================================================================*
