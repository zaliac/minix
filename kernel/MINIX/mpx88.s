| 14 进程汇编.(Minix Process Extension) This file is part of the lowest layer of the MINIX kernel.  All processing
...
|*===========================================================================*
|*				s_call	: proc.c sys_call(function, caller, src_dest, m_ptr) *
|*===========================================================================*
...
|*===========================================================================*
|*				clock_int	时钟硬件发生中断时,CPU自动调用的中断处理程序.	     *
|*===========================================================================*
...
save:				| save the machine state in the proc table.  
	...
	mov ss,bx		| set ss
	push ds_save	| 开始保存当前进程的所有寄存器值,为中断结束后,重启被中断的用户进程做准备.start saving all the registers, sp first
...
|*===========================================================================*
|*				restart		:恢复save过程中保存的被中断的各寄存品的值.	     *
|*===========================================================================*
