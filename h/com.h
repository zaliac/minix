...
/* 任务号Task numbers, 功能码function codes and 回复码reply codes. */
...
#define MEM               -4	/* /dev/ram, /dev/(k)mem and /dev/null class 内存*/
#	define RAM_DEV     0	/* minor device for /dev/ram */
#	define MEM_DEV     1	/* minor device for /dev/mem */
#	define KMEM_DEV    2	/* minor device for /dev/kmem */
#	define NULL_DEV    3	/* minor device for /dev/null */

#define FLOPPY            -5	/* floppy disk class 软驱/
...
#define TTY               -7	/* terminal I/O class 终端*/
#define PRINTER           -8	/* printer  I/O class 打印机*/
